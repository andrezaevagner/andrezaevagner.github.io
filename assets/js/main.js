$(document).ready(function() {
  ...
  var target_date = new Date("2018-01-06T21:30:00.000+03:00").getTime();
  ...
  var years_span = document.createElement("SPAN");
  years_span.className = 'days';
  countdown.appendChild(years_span);
  ...
  setInterval(function() {
    ...
    days = parseInt((seconds_left / 86400) % 365);
    ...
    years_span.innerHTML = '<span class="number">' + years + '</span>' + '<span class="unit script">Anos</span>';
